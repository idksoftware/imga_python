...
class CheckoutImageCtrl(scrolledpanel.ScrolledPanel):
    pageName = "CheckoutPage"
    def __init__(self, parent, style=wx.TAB_TRAVERSAL):
        super(CheckoutImageCtrl, self).__init__(parent, style=style)
    ...
    def __DoLayout(self):
        ...
        title_lbl= wx.StaticText(self, label="Checkout Images")
...
class MainPane(wx.Notebook):
    ...
    def __init__(self, parent):
        ...
        self.AddPage(self.checkoutImageCtrl, "Finance")
