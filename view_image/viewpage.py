...
class ViewImageCtrl(scrolledpanel.ScrolledPanel):
    pageName = "View Page"
    def __init__(self, parent, style=wx.TAB_TRAVERSAL):
        super(ViewImageCtrl, self).__init__(parent, style=style)
    ...
    def __DoLayout(self):
        ...
        title_lbl= wx.StaticText(self, label="View Images")
...
class MainPane(wx.Notebook):
    ...
    def __init__(self, parent):
        ...
        self.AddPage(self.viewImageCtrl, "Finance")
