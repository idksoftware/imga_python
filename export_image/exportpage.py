...
class ExportImageCtrl(scrolledpanel.ScrolledPanel):
    pageName = "ExportPage"
    def __init__(self, parent, style=wx.TAB_TRAVERSAL):
        super(ExportImageCtrl, self).__init__(parent, style=style)
    ...
    def __DoLayout(self):
        ...
        title_lbl= wx.StaticText(self, label="Export Images")
...
class MainPane(wx.Notebook):
    ...
    def __init__(self, parent):
        ...
        self.AddPage(self.exportImageCtrl, "Finance")
